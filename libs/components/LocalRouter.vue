<template>
  <div class="">
    ...
    <router-link to="/i/tools" :class="'btn btn-outline-dark btn-sm border-0 fw-bold fs-5 text-decoration-none my-1 ' + (isBlock ? 'd-block ' : 'me-1 ') + ($route.name === 'tool-main-page' ? 'active ' : '')">{{ t("timeline.side_tags.tools") }}</router-link>

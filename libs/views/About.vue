<template>
  <div id="about">
    <single-page-header title="关于" />
    <div class="container">
      <div class="row">
        <div class="col-md-10 offset-md-1">
          <h3>以前的事</h3>
          <p>爬Twitter这事我已经不是第一天干了，最早可以追溯到2016年底，虽然本站几乎所有代码都经过一次甚至数次重写，但是思路就源于那个时候</p>
          ...
          <el-divider class="my-4" />
          <h3>关于旧版（v1）</h3>
          <p>虽然旧的版本的数据不再更新，但还是可以访问的，<a href="https://tm.bangdream.fun/tmv1/index.html" target="_blank">回到旧版</a>，即将合并旧版数据</p>
          ...
          <el-divider class="my-4" />
          <h3>交流</h3>
          <p>有何意见，有何建议，畅所欲言，但请不要发出您认为不应该在群组作出的发言，<abbr title="Safe For Work">SFW</abbr>，谢绝广告</p>
          <ul>
              <li>Telegram群：<a href="https://t.me/tmtg_cn" target="_blank">https://t.me/tmtg_cn</a></li>
              <li>GitHub Discussions：<a href="https://github.com/BANKA2017/twitter-monitor/discussions" target="_blank">BANKA2017/twitter-monitor Discussions</a></li>
          </ul>
          <el-divider class="my-4" />
          <h3>开源</h3>
...
export default defineComponent({
  components: {SinglePageHeader, ArrowLeft},
  setup() {
    useHead({
      title: '关于',
      meta: [{

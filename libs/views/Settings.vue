        ...
        <div class="col-lg-9">
          ...
          <div class="input-group mb-3">
            ...
            <select id="select-platform" v-model="translatorPlatform" class="form-select">
              <option v-for="translateMeta in [['google', 'Google Translate'], ['microsoft', 'Microsoft Translator'], ['yandex', 'Yandex Translator']]" :key="translateMeta[0]" :selected="translatorPlatform === translateMeta[0]" :value="translateMeta[0]">{{ translateMeta[1] }}
              </option>
            </select>
          </div>

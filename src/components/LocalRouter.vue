<template>
  <div class="">
    ...
    <router-link to="/about/" :class="'btn btn-outline-dark btn-sm border-0 fw-bold fs-5 text-decoration-none my-1 ' + (isBlock ? 'd-block' : 'me-1')">{{ t("timeline.side_tags.about") }}</router-link>
